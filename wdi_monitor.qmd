...
score_table <- mutate(score_table, across(contains("_score_hybrid"), ~ round(., 2)))
```
...
htmltools::div(
  class = "custom-card",
  style = paste0("background-color: ", metadata_color, "; color: white; padding: 20px;"),
  htmltools::a(
    href = "#metadata",
    style = card_style,
    htmltools::tags$i(
    ...
    htmltools::p(
      "Indicators lacking required metadata",
      style = card_p_style
    ),
    htmltools::h3(
      metadata_count, 
...
htmltools::div(
  class = "custom-card",
  style = paste0("background-color: ", license_color, "; color: white; padding: 20px;"),
  htmltools::a(
    href = "#license",
    style = card_style,
    htmltools::tags$i(
      class = "bi bi-cc-circle fa-3x", 
      style = icon_style
    ),
    htmltools::p(
      "Indicators lacking CC BY 4.0 license",
      style = card_p_style
    ),
    htmltools::h3(
      license_count, 
...
htmltools::div(
  class = "custom-card",
  style = paste0("background-color: ", user_color, "; color: white; padding: 20px;"),
  htmltools::a(
    href = "#user-metrics",
    style = card_style,
    htmltools::tags$i(
      class = "bi bi-file-earmark-arrow-down fa-3x", 
      style = icon_style
    ),
    htmltools::p(
      "Indicators with less than 50 visitors last 12 months",
      style = card_p_style
    ),
    htmltools::h3(
      user_count, 
...
htmltools::div(
  class = "custom-card",
  style = paste0("background-color: ", country_color, "; color: white; padding: 20px;"),
  htmltools::a(
    href = "#country-coverage",
    style = card_style,
    htmltools::tags$i(
      class = "bi bi-globe fa-3x", 
      style = icon_style
    ),
    htmltools::p(
      "Indicators with poor country coverage (under 50 countries)",
      style = card_p_style
    ),
    htmltools::h3(
      country_count, 
...
htmltools::div(
  class = "custom-card",
  style = paste0("background-color: ", time_color, "; color: white; padding: 20px;"),
  htmltools::a(
    href = "#time-coverage",
    style = card_style,
    htmltools::tags$i(
      class = "bi bi-calendar-check fa-3x", 
      style = icon_style
    ),
    htmltools::p(
      "Indicators with no data in last 10 years",
      style = card_p_style
    ),
    htmltools::h3(
      time_count, 
...
ctr_table <- select(score_table, Indicator.Code, Indicator.Name, geographic_score_hybrid, n_country, n_lmic, p_lmic, datatopic) %>%
...
reactable(
  time_table,  # Use the correct dataset
  filterable = TRUE,
  columns = list(
    Indicator.Code = colDef(name = "Code"),
    Indicator.Name = colDef(name = "Name"),
